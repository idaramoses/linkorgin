  ...
  const handleNext = (): void => {
    if(currentStep===1){
      ...
      if (!isPasswordValid(password) ||!isPasswordValid(confirmpassword)) {
        setError('Password must contain at least one capital letter, one lowercase letter,  and  must not be less than 6 characters in length');
        return;
      }
    }
    if(currentStep===2){
...
<option value="Zimbabwe">Zimbabwe</option>
        ...
        <div className="pointer-events-none absolute inset-0 left-auto right-5 flex items-center">
          ...
          <select value={nativeLanguage} onChange={handleNativeLanguageChange}  className="h-8   text-gray-600 text-base font-hankengrotesk w-full  ">
            ...
            <div className="self-end mt-10 w-full flex flex-col items-center justify-center">
             
                              <div className="flex w-[58%] my-5 items-center gap-[11px] md:w-full">
                              <Text size="4xl" as="p" className=" !font-kumbhsans !text-blue_gray-700_01">
                                <>
