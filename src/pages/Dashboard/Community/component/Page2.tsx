          ...
          {d.wherecani}
                ...
                <div className="flex md:pt-5 pt-20 w-[30%] px-5  items-center justify-center md:hidden   flex-col gap-[29px] md:w-full">
                  <div className="flex flex-col items-start gap-[21px]">
                    ...
                    Feeling lost and need a helping hand? You're in the right place!  Mon-Ami can be your bridge to the amazing community resources available.  Tell me what kind of support you're looking for, whether it's a support group, a cultural association, or something else, and I'll help you find the perfect match.                   </p>
                    </div>
                  </div>
