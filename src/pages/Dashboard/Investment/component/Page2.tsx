...
setLong(province.longitude);
      ...
      {!loading && !error && clinics.length === 0 && <div className="flex flex-col">  <p className=" md:text-2xl text-3xl self-start bg-gradient2 bg-clip-text !text-transparent !font-kumbhsans ">
          Mon - Ami
         </p>
      <div className="mt-5  text-sm text-black w-full">
      Hey there! Mon-Ami here, at your service to help you settle into your new Canadian neighborhood! Finding the right local resources can make a big difference. Whether you need to search for specific businesses or want personalized recommendations, I'm here to guide you!      </div></div>}
      </div>
