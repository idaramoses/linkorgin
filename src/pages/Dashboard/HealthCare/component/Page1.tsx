      ...
      <div className="mt-16 w-full md:mt-10 md:w-full">
        <div className="flex gap-2 md:flex-col max-md:gap-0">
          ...
          <div onClick={() => handlequicklink('Do you have questions about applying for visas or permanent residency','Immigration and Citizenship')} className="flex flex-col h-40  cursor-pointer items-center grow px-4 py-2 w-full bg-white rounded-xl border border-solid border-zinc-300 md:mt-4">       
           ...
           Need a primary care provider? I can help you find General Practitioners (GPs)
            </div>
           </div>
          </div>
          <div className="flex flex-col ml-5 w-3/12 md:ml-0 md:w-full">
            <div onClick={() => handlequicklink('Do you require specialized care? I can help you connect with the right Specialists in your area, like pediatricians, cardiologists, or dermatologists','Social Services & Benefits')} className="grow px-4 py-2  h-40 flex  cursor-pointer items-center w-full  bg-white rounded-xl text-sm border border-solid border-zinc-300 text-neutral-700 max-md:mt-7">
          Do you require specialized care? I can help you connect with the right Specialists in your area
              <br />
            </div>
          </div>
          <div onClick={() => handlequicklink('Looking for convenient and accessible healthcare services? I can guide you to nearby Community Health Centers offering various services like vaccinations, womens health, or mental health support.','Employment Services')}  className="flex flex-col ml-5 w-3/12 md:ml-0 md:w-full">
           ...
           Looking for convenient and accessible healthcare services? I can guide you to nearby Community Health Centers
            </div>
          </div>
