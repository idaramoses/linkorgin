          ...
          <Settings/>
            ...
            <div className="flex md:pt-5 pt-40 w-[30%] md:hidden border-l border-gray-300 md:border-none px-5 flex-col gap-[29px] md:w-full">
              <div className="flex flex-col items-start gap-[21px]">
                <div className="flex w-[44%] flex-col items-center justify-center gap-[7px] rounded-[7px] bg-red-400_01 p-6 md:w-full sm:p-5">
                  <Img src="/images/img_thumbs_up.svg" alt="home_one" className="h-[23px] self-center" />
