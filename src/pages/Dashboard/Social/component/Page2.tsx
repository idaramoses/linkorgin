...
function Page2({ togglePage}: Page1Props){
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    fetchGoogleSearchResults();
      ...
      Hey there! Mon-Ami here, your guide to exploring Canada's vibrant social scene! Craving delicious food, lively entertainment, or a fun workout spot? Let's find the perfect place for you!</div></div>}
      </div>
