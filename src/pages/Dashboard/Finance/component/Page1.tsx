               ...
               <div className="flex md:pt-5 pt-20 w-[30%] px-5  items-center justify-center md:hidden   flex-col gap-[29px] md:w-full">
                  <div className="flex flex-col items-start gap-[21px]">
                    ...
                    <div className="self-stretch rounded-[10px] bg-gray-200 p-[18px]">
                      ...
                      Financial security is an important part of settling in. Explore financial service providers with Mon-Ami's search assistance!  We have listings for banks, credit unions, financial advisors, and more, all catering specifically to immigrant populations.  Whether you have general questions about financial matters or need help finding specific services like budgeting or opening a bank account, Mon-Ami is here for you!           
                                </p>
                                  </div>
                  </div>
