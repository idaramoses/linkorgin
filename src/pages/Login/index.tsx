          ...
          <div className="flex flex-col items-center justify-center w-full ">
               ...
               <div className="mt-20 md:mt-10 flex w-72 my-10  mx-auto items-center justify-between gap-2 rounded-[15px] bg-gray-100_89 p-[5px] ">
                          ...
                          <Button
                            ...
                            size="lg"
                            variant="fill"
                            className=" rounded-[10px] text-base font-inter font-semibold "
...
>
                ...
                <button  className="justify-center self-end px-11 py-5 mt-10 text-base font-semibold text-white-A700 whitespace-nowrap bg-[#3864FF] rounded-[31.5px] md:px-5">
                  Login
                </button>
                </div>
